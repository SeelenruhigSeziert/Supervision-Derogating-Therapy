  ...
  head: () => ({
    meta: [
      ...
      { name: "description", content: DESCRIPTION },
      {
        name: "keywords",
        content:
          "Supervision, Therapeuten Bewertung, blinder Fleck, Machtgefälle, Psychotherapie Kammer Beschwerde, Satire, Kritik, unseriöse Therapie, Opitz, Raub-Auer",
      },
    ...
    <main className="min-h-screen bg-[#1a1512] text-[#e8ddd1]">
      <article className="mx-auto max-w-3xl px-6 py-20 sm:py-28">
        ...
        <div className="space-y-6 font-serif text-lg leading-relaxed text-[#d8ccbd]">
          ...
          <p>
            „Galater 6,7“, fährt sie fort, während sie einen Schluck vom Tee nimmt. „Was der Mensch sät, das wird er ernten. Lukas 17,17: ‚Wo sind die neun?‘ – Der Satz ist kurz, fast schon lakonisch, und wird oft als Kommentar zu Undankbarkeit, fehlender Selbstreflexion oder menschlicher Gleichgültigkeit verstanden.“ Opitz starrt Raub-Auer auf die Füße.
          </p>
          <p>
          ...
          <p>
            „Es steht alles geschrieben“, entgegnet Frau Opitz ungerührt. Sie lehnt sich in ihrem Sessel zurück, verschränkt die Arme und fixiert die Kollegin Raub-Auer mit einem Blick, der keine Regung zeigt. „‚Wer die Ohren verschließt vor dem Schreien des Armen, der wird auch rufen und nicht gehört werden.‘ Sprüche 21,13. Ihre Patienten schreien, Frau Raubbauer. Aber Sie hören nur das Rascheln Ihrer Honorarnoten und den klangvollen Glanz Ihres Spiegelbildes. Wer nur einen Hammer hat, für den sieht jedes Problem wie ein Nagel aus.“
          </p>
          <p>
            Ein schweres, bleiernes Schweigen legt sich über den Raum. Die schwüle Hitze drückt. Ina spürt, wie ihr die Haare im Nacken kleben, doch sie weigert sich, sich auch nur einen Zentimeter zu bewegen. Sie hält dem starren Blick von Frau Opitz stand. Eine Minute vergeht. Das Ticken einer Wanduhr, die irgendwo im Flur schlägt, ist das einzige Geräusch. Zwei Minuten. Keines der beiden Gesichter rührt sich. Es ist ein eisiger, stummer Krieg im stickigen Raum. Schließlich bricht Ina die Stille. Sie blickt demonstrativ auf ihre altmodische Armbanduhr, zieht einen Mundwinkel kühl nach oben und erhebt sich mit kontrollierter Eleganz.
          </p>
          <p>
            „Nun, ich kann ja angeblich keine Kritik vertragen“, sagt sie mit schneidender Gelassenheit, während sie ihre Regenjacke glattstreicht. „Ich würde sagen, ich habe Ihnen heute das Gegenteil bewiesen. Ich habe mir Ihre... unkonventionellen Projektionen volle zwei Minuten lang schweigend angehört. Sind wir jetzt fertig?“ Frau Opitz bewegt keinen Muskel. Ihr Blick bleibt auf den leeren Stuhl gerichtet, auf dem Ina gerade noch saß.
          </p>
          <p>
            „Alles hat seine Zeit“, entgegnet Frau Opitz leise und greift wieder nach dem Kugelschreiber, um die restlichen Hinterlassenschaften von ihrer Sohle zu kratzen. „Auch die Einsicht. Gehen Sie nur, Frau Raubbauer. Sie können sich weder von sich selbst entfernen noch sich selbst erreichen.“
          </p>
          <p>
            „RAUB-AUER! Das ist ja gestört... WAS wollen Sie hören? Worüber wir hier sprechen, entscheiden Sie, Frau Opitz!“, lamentiert sie und wirft dabei theatralisch die Arme in die Luft. „Sie manipulieren mich nicht, Frau Kollegin. Geben Sie mir die Packung Taschentücher da drüben“, entgegnet Opitz und streckt eine offene Hand wartend Richtung Raub-Auer.
          </p>
          <p>
            „Warum haben Sie eigentlich Hundekot unterm Schuh, Frau Oh-pütz?“
          </p>
          <p>
            „Opitz. Ich heiße Opitz. ‚Was geschehen ist, wird wieder sein, und was getan worden ist, wird wieder getan werden; es gibt nichts Neues unter der Sonne.‘ Prediger 1,9“, zitiert sie achselzuckend mit müdem Blick auf ihre Schuhsohle.
          </p>
          <p>
            Raub-Auer fixiert sie, die Augenlider leicht verengt. „Was soll man daraus denn lernen?“, ein gelangweilt-spöttischer Unterton schwingt in dieser Frage mit. „Fällt Ihnen eigentlich NICHTS auf, wenn Sie aus dem Fenster schauen?“, fragt Frau Opitz, während sie beiden eine Tasse Tee eingießt.
          </p>
          <p>
          ...
          <p>
            „Jaaa, die Kammerbeschwerde wegen dieser verweichlichten Patienten." stöhnt Ina Raub-Auer „Warum praktizieren SIE eigentlich noch bei so vielen absurden 1-Sterne-Bewertungen, Frau Opitz? Und dieser Mann in Unterhose-“
          </p>
          <p>
            Frau Opitz unterbricht sie: „Da war kein Mann in Unterhose, Raubbauerin!“, unterbricht Frau Opitz sie mit einer fast schon unheimlichen Sanftheit. Sie stellt die Teetasse so präzise auf dem Unterteller ab, dass kein einziges Geräusch entsteht. „Das ist das erste Glied der Kette, die Sie sich im Leben geschmiedet haben. Glied um Glied, Zentimeter um Zentimeter. Sie haben sie aus freiem Willen angelegt.“
          </p>
          <p>
            Therapeutin Raub-Auer rollt so heftig mit den Augen, dass es fast wehtut. „Hören Sie mir bloß auf mit Dickens. Als Nächstes erzählen Sie mir wahrscheinlich, dass gleich der Geist der vergangenen Supervisionen durch die Tür schwebt. Wir sind hier nicht in einer Weihnachtsgeschichte, Frau Opitz, sondern in einer völlig verfahrenen, kollegialen Pflichtveranstaltung. Und die Kammer wird sich brennend für Ihre... messianischen Allüren interessieren.“
          </p>
          <p>
            Frau Opitz reagiert gar nicht auf die Drohung. Sie schaut nicht mal zu Ina. Ihr Blick wandert stattdessen langsam zum Fenster, an dem der Regen unaufhörlich herabrinnt. Die Tropfen wirken merkwürdig zäh, fast wie Sirup.
          </p>
          <p>
            „Schauen Sie doch mal hin“, sagt Frau Opitz leise, fast beschwörend, und deutet mit dem schmutzigen Kugelschreiber vage nach draußen. „Sehen Sie den Mann auf der anderen Straßenseite? Der mit dem nassen, grauen Mantel, der seit zwei Stunden versucht, sein Auto aufzuschließen?“
          </p>
          <p>
          ...
          <p>
            „Sind Sie das?“, bohrt die eigensinnige Psychologin Opitz und hebt langsam den Blick. Ihre Augen fixieren Ina mit einer bodenlosen, mitleidigen Schwere. „Wann sind Sie denn losgefahren, Kindchen? Welches Jahr haben wir? Welcher Monat ist draußen?“
          </p>
          <p>
          ...
          <p>
            „Ich klammere mich nicht an die Bibel, weil ich gläubig bin“, fährt Frau Opitz ungerührt fort, als hätte Ina gar nichts gesagt. Sie streicht mit einem blassen Finger über das Buch. „Ich zitiere sie, weil es das Einzige ist, was in diesem Raum echt ist. Der Text bleibt gleich. Alles andere... schauen Sie sich doch um. Jedes Mal, wenn wir von vorne beginnen, ist der Fleck unterm Schuh ein bisschen größer. Jedes Mal sitzen wir hier, und Sie zählen mir Ihre drei abgesagten Patienten auf. Immer dieselben drei. Seit wie vielen Ewigkeiten wohl?“
          </p>
          <p>
          ...
          <p>
            Frau Opitz lehnt sich mit selbstzufrieden traktierendem Blick zurück. Der Kugelschreiber ruht auf der Bibel. Sie nimmt einen Schluck vom Tee und stellt die Tasse voller als sie zuvor noch war, zurück. „Erst dann“, flüstert sie. Das Handy von Frau Raub-Auer lässt einen Kurznachrichten-Ton durchs Zimmer scheppern. Die Frauen starren sich wortlos an, gleichermaßen um die Kontrolle ihrer Mimik bemüht.
          </p>
          <p>
            „Na, machen Sie schon, schauen Sie, was es ist!“, raunt Therapeutin Opitz unwirsch und blickt wieder zu dem dunklen Fleck auf der Wiese vor dem Fenster. Raub-Auer blickt auf das Display ihres Handys. „Eine 1-Sterne-Bewertung. Aber ich kann sie nicht öffnen.“ Sie legt das Handy mit genervter Mimik beiseite und schnauft. „Es geht mir nicht um MACHT, Frau Opitz!“
          </p>
          <p>
            Draußen donnert und blitzt es in diesem Moment wie das Räuspern einer höheren Macht. Frau Opitz lässt den Kopf sinken. „Aber natürlich, Kindchen.“ Wieder blitzt es draußen. Raub-Auer glaubt einen Moment, den Verstand zu verlieren, als sie meint, ihren Tee plötzlich dampfen zu sehen.
          </p>
          <p>
            „Das sind IHRE Bewertungen, Frau Opitz! Warum machen Sie überhaupt noch weiter? Es geht Ihnen um Aufmerksamkeit, richtig?“, sie spielt nervös mit einem Haargummi welches sie, Kollegin Opitz musternd, aus ihrer Hosentasche hervorkramt. „Wissen Sie, eine echte Therapeutin zu sein, ist wirklich mit viel Leid verbunden. Ich kann das aushalten!“ merkt sie nonchalant an „Aber Sie... Sie attestieren Menschen eine Wahrnehmungsstörung, da sie eine Brille haben, und –“
          </p>
          <p>
            „DROGENDEALERIN!“, fährt Opitz ihr schroff dazwischen. „Alles ist eitel und ein Haschen nach Wind“, setzt sie mit einer abwehrenden Kopfbewegung fort.
          </p>
          <p>
          ...
          <p>
            Frau Opitz neigt den Kopf leicht zur Seite. Ihr Blick hat jetzt etwas unerträglich Traktierendes, fast Mitleidiges.
          </p>
          <p>
          ...
          <p>
            „Trinken Sie ruhig“, sagt Frau Opitz leise. „Wir haben noch sehr viele Sitzungen vor uns. Und Herr Freder wird draußen im Regen nicht müde.“
          </p>
          <p>
            Ina starrt auf das bitter duftende Gemisch in ihrer Tasse. Der Dampf schlägt ihr entgegen, schwer und erstickend. „Ihr Klient...“, setzt Frau Opitz mit dieser unerträglichen, ruhigen Stimme an.
          </p>
          <p>
            „Patient!“, bricht es reflexartig aus Raub-Auer heraus. Ihre Stimme klingt scharf, ein vertrauter, mühsam aufrechterhaltener Schutzwall. „Es sind Patienten, Frau Opitz. Ein klinisches Setting erfordert klare, asymmetrische Strukturen. Diese begriffliche Verwässerung gefährdet die therapeutische Abgrenzung. ICH bin gesund. Normal. Lebensfähig. Ich habe Deutungshoheit.“
          </p>
          <p>
            Frau Opitz zuckt nicht einmal. Ein mattes, befremdliches Lächeln liegt auf ihren Lippen, als sie langsam den Kopf schüttelt. „Nennen Sie es, wie es Ihr Ego braucht, Kindchen. Aber Ihr Klient hatte etwas, das Ihnen völlig abgeht: Er stand mit beiden Beinen im echten Leben, analytisch, wehrhaft. Er brauchte keine Krücken. Sie wollten ihm einreden, er bräuchte sie, um sich selbst als die große Retterin zu inszenieren. Aber er war lebensfähig. Sie sind es nicht. Sie überleben nur in diesem künstlichen Vakuum aus Macht, Krankheit und Abwertung.“
          </p>
          <p>
          ...
          <p>
            Frau Opitz nimmt einen langsamen Schluck von ihrem Tee. Sie blickt ruhig auf die Tasse, dann wieder zu Ina Raub-Auer. Ihre Akzeptanz für die eigene Demontage hat etwas zutiefst Unheimliches, fast Erhabenes.
          </p>
          <p>
            „Ja“, sagt Frau Opitz leise, und ihre Augen glänzen matt im fahlen Licht. „Die Menschen schreiben schreckliche Dinge. Sie schimpfen, sie klagen an, sie geben mir einen einzigen Stern. Und wissen Sie was? Sie haben recht. Ich nehme das an. Ich trage diese Schande, weil ich weiß, wer ich bin. Und ja, ich brauche das Geld. Aber diese Supervision hier...“, sie klopft mit dem schmutzigen Kugelschreiber zweimal sachte auf das Leder der Bibel, „...die findet ihretwegen statt, Frau Raubbauer. Nicht wegen meiner Fehler. Ich bin nur die Kulisse. Der Spiegel, den man Ihnen hinstellt.“
          </p>
          <p>
          ...
          <p>
            „Es ist nicht das Ende“, lächelte Opitz, und dieses Lächeln war von einer tiefen, traurigen Wärme durchzogen. „Es ist erst die neunte Sitzung.“
          </p>
          <p>
            Ein Montag im Herbst. Es regnete, es war grau, schwüle 19 Grad, die sich anfühlten wie 23.
          </p>
          <p>
            Ina Raub-Auer klingelte mit genervter Miene an der Praxistür von Diplom Psychologin Opitz. Diese kommt plötzlich von hinten angelaufen. „Wir hatten heute einen Termin!“, sagt Raub-Auer latent entrüstet. „Das musst du aber noch üben“, denkt sie sich abfällig bezüglich des unpünktlichen Erscheinens. Sie grinst abschätzig einseitig.
          </p>
          <p>
            „Ja, das mag sein“, entgegnet Frau Opitz forsch, als sie die Tür aufschließt. „Ich musste noch ins Fitnessstudio.“
          </p>
          <p>
            Im Therapieraum angekommen, legte Opitz die Bibel neben ihren Sessel und ließ sich nieder. Das Zimmer roch intensiv nach feuchter Erde, bitterem Tee und nassem Hundefell, doch Ina bemerkte es kaum. Sie spürte nur diese seltsame, chronische Müdigkeit in ihren Knochen, als hätte sie eine Ewigkeit nicht geschlafen.
          </p>
          <p>
            „Sie tragen ja noch immer diese Brille. Sie sind deshalb wahrnehmungsgestört, Frau Raubbauer“, sagte Opitz, während sie sich setzte.
          </p>
          <p>
          ...
          <p>
            „RAUB-AUER!“, berichtigt sie Frau Opitz und fuhr mit vertrauter, eisiger Gelassenheit fort: „... das ist doch vergebene Liebesmüh. Für Sie habe ich heute drei Patienten abgesagt.“
          </p>
          <p>
            Frau Opitz sah sie an. In ihren Augen lag kein Triumph, nur die unendliche, gelangweilte Geduld einer Gefängniswärterin, die weiß, dass die Insassin den Ausgang vor lauter Stolz niemals finden wird. Sie griff nach ihrem Kugelschreiber und begann, ein frisches, feuchtes Stück Dreck unter ihrer linken Sohle hervorzuprokeln.
          </p>
          <p>
            „Alles hat seine Zeit“, erwiderte Opitz leise.
          </p>
          <p>
